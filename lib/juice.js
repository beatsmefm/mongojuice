...
Juicer.prototype.init = function(config, callback) {
    ...
    mongoUrl += db.replica || (db.host + ':' + db.port + '/' + db.name);
    logger.info("Trying to connect to mongodb: %s", mongoUrl);
    var c = { replset: { rs_name: 'crater-1' }};
    mongoose.connect("mongodb://beatsme:wegotthebeat@10.12.31.175:27017/cratefm,mongodb://beatsme:wegotthebeat@10.12.31.123:27017,mongodb://beatsme:wegotthebeat@10.12.31.132:27017,mongodb://beatsme:wegotthebeat@10.12.29.90:27017",
        c, 
        _.bind(function(err, connected){
        console.log("mongoose connect msgs", err, connected);
        if(config.models) {
