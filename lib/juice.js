...
Juicer.prototype.blend = function(key, params, callback) {
    ...
    if(blender.cache && blender.cache.hashkey && blender.cache.resultkey) {
        ...
        this.cache.get(hashkey, resultkey, _.bind(function(err, result){
            ...
            this._blend(blender, key, params, hashkey, resultkey, callback);
...
Juicer.prototype._blend = function(blender, key, params, hashkey, resultkey, callback){
    blender.blend(key, params, _.bind(function(err, result){
        callback(err, result);
        if(blender.cache){
